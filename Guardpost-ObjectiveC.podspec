...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of Guardpost-ObjectiveC
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Sam Davies" => "sam@visualputty.co.uk", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Sam Davies', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "https://github.com/sammyd/GuardPost-ObjectiveC.git", :commit => "35c49ea273bb506116ce4d7f4ebe2b333e8ae40b" }
